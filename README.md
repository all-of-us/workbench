...
## DevOps
The `devops` toolkit is described [here](ops/ruby/devops-framework/DEVOPS_FRAMEWORK.md). Other
documentation (including the playbook) is available for oncall engineers. This toolkit
is independent of the build and release system, and may be used by any GCP applicaiton
