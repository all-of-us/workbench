...
const local: IEnvConfig = {
  ...
  API_HOSTNAME: process.env.API_HOSTNAME || 'http://localhost:8081',
...
const test: IEnvConfig = {
  ...
  API_HOSTNAME: process.env.API_HOSTNAME || 'https://api-dot-all-of-us-workbench-test.appspot.com',
  EMAIL_DOMAIN_NAME: '@fake-research-aou.org',
  WRITER_USER: process.env.WRITER_USER || 'puppetmaster@fake-research-aou.org',
...
const staging: IEnvConfig = {
  ...
  API_HOSTNAME: process.env.API_HOSTNAME || 'https://api-dot-all-of-us-rw-staging.appspot.com',
...
const stable: IEnvConfig = {
  ...
  API_HOSTNAME: process.env.API_HOSTNAME || 'https://api-dot-all-of-us-rw-stable.appspot.com',
...
const perf: IEnvConfig = {
  ...
  API_HOSTNAME: process.env.API_HOSTNAME || 'https://api-dot-all-of-us-rw-perf.appspot.com',
