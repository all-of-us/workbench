...
describe('Updating runtime parameters', () => {
  ...
  test('Switch from GCE to dataproc', async() => {
    ...
    await notebook.runCodeCell(4, {codeFile: 'resources/python-code/import-libs.py'});
    const sparkOutputText = await notebook.runCodeCell(3, {codeFile: 'resources/python-code/spark-context.py'});
    // TODO: analyze this
