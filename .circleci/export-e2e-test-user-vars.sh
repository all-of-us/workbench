...
do
  case "$arg" in
    "perf")
       echo "export PERF_READER=$PUPPETEER_READER_PERF" >> $BASH_ENV
       ...
       ;;
    "staging")
       echo "export STAGING_READER=$PUPPETEER_READER_STAGING" >> $BASH_ENV
       ...
       ;;
    "test")
       echo "export TEST_READER=$PUPPETEER_READER_TEST" >> $BASH_ENV
       ...
       ;;
    "local")
       echo "export DEV_READER=$PUPPETEER_READER_LOCAL" >> $BASH_ENV
