...
public class DataBrowserController implements DataBrowserApiDelegate {
     ...
     * client representation (generated by Swagger).
     */
    private static final Function<ConceptAnalysis, org.pmiops.workbench.model.ConceptAnalysis>
            TO_CLIENT_CONCEPTANALYSIS=
            new Function<ConceptAnalysis, org.pmiops.workbench.model.ConceptAnalysis>() {
                @Override
                public org.pmiops.workbench.model.ConceptAnalysis apply(ConceptAnalysis ca) {
                    return new org.pmiops.workbench.model.ConceptAnalysis()
