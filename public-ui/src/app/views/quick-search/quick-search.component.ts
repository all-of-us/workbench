...
export class QuickSearchComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    if (this.dataType === this.EHR_DATATYPE) {
      ...
      this.subTitle = 'Enter a keyword or data standards code (eg ICD, SNOMED) in the search bar to search across Electronic Health Record (EHR) data and program surveys.';
    }
