...
public interface CriteriaDao extends CrudRepository<Criteria, Long> {
  ...
  // TODO:Remove freemabd
  List<Criteria> findCriteriaByTypeAndParentIdOrderByIdAsc(
  ...
  @Query(
      value =
          "select * "
              ...
              + "and is_selectable = 1",
      nativeQuery = true)
  List<Criteria> findCriteriaLeavesByTypeAndParentCodeRegex(
      @Param("type") String type,
      @Param("subtype") String subtype,
  ...
  // TODO:Remove freemabd
  List<Criteria> findCriteriaByTypeAndSubtypeAndParentIdOrderByIdAsc(
      @Param("type") String type,
      @Param("subtype") String subtype,
  ...
  @Query(
      value =
          "select cr from Criteria cr "
              + "    where cr.type = upper(?1) "
              + "    and (match(synonyms, ?2) > 0 or cr.code like upper(concat(?3,'%')))"
              + "    order by cr.count desc")
  // TODO:Remove freemabd
  List<Criteria> findCriteriaByTypeForCodeOrName(
      String type, String modifiedValue, String value, Pageable page);
  ...
  @Query(
      value =
          "select cr from Criteria cr "
              ...
              + "    order by cr.count desc")
  // TODO:Remove freemabd
  List<Criteria> findCriteriaByTypeAndSubtypeForCodeOrName(
      String type, String subtype, String modifiedValue, String value, Pageable page);
  ...
  @Query(
      value =
          "select cr from Criteria cr "
              ...
              + "    order by cr.count desc")
  // TODO:Remove freemabd
  List<Criteria> findCriteriaByTypeAndSubtypeForName(
      String type, String subtype, String value, Pageable page);
  ...
  @Query(
      ...
      nativeQuery = true)
  // TODO:Remove freemabd
  List<Criteria> findCriteriaByTypeAndSubtypeOrderByIdAsc(
  ...
  @Query(
      ...
      nativeQuery = true)
  // TODO:Remove freemabd
  List<Criteria> findDrugBrandOrIngredientByValue(
  ...
  @Query(
      value =
          "select * from criteria c "
              ...
              + "and c.type = 'DRUG' and c.subtype = 'ATC'",
      nativeQuery = true)
