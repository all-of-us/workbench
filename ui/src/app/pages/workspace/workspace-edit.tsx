        ...
        <WorkspaceEditSection header={researchPurposeQuestions[8].header} index='6.' indent={true}>
          <FlexRow style={styles.text}><div>
            ...
            <TooltipTrigger content={toolTipTextDemographic} style={{display: 'inline-block'}}>
              <AoULink style={{display: 'inline-block'}}>uses
              demographic variables</AoULink>
            </TooltipTrigger>
            ...
            <TooltipTrigger content={toolTipTextDucc}>
              <AoULink style={{display: 'inline-block'}}>Data User Code of Conduct agreement.</AoULink>
            </TooltipTrigger>
            ...
            <AoULink style={{display: 'inline-block'}}><AoU/> Stigmatizing Research Policy</AoULink>
