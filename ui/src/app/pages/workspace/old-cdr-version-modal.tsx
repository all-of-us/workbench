...
const OldCdrVersionModal = (props: Props) => {
  ...
  return (
    <Modal width={550}>
      <ModalTitle
        data-test-id='old-cdr-version-modal'
        style={{ fontSize: '16px' }}
      >
      ...
      <ModalBody>
        <FlexColumn>
          <div style={styles.text}>
            Use of older dataset versions is{' '}
            <StyledExternalLink href='https://www.researchallofus.org/data-tools/data-access/'>
              permitted
            </StyledExternalLink>{' '}
            only to complete a study that was started using that older version,
            or to replicate a previous study. You must confirm the following to
            continue.
          </div>
          <div style={{ margin: '24px 0' }} data-test-id='consent-will-use'>
            <CheckBox
          ...
          <div data-test-id='consent-will-identify'>
            <CheckBox
              style={styles.checkbox}
              labelStyle={styles.text}
      ...
      <ModalFooter>
        ...
        <Button type='primary' onClick={onContinue} disabled={!canContinue}>
          Continue
        </Button>
      </ModalFooter>
    </Modal>
