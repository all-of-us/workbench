      ...
      <FadeBox style={{marginTop: '1rem', marginLeft: '1rem', width: '1239px'}}>
        ...
        <FlexRow style={{justifyContent: 'flex-end', marginRight: '1rem'}}>
          <div>
            ...
            <TooltipTrigger content={
              errors && isAddInstitution && <BulletAlignedUnorderedList>
                {errors.displayName && <li>{errors.displayName}</li>}
                {errors.organizationTypeEnum && <li>You must select Institution type</li>}
                {errors.duaTypeEnum && <li>You must select Agreement type</li>}
                {errors.emailAddresses && <li>Email Address cannot be empty</li>}
        ...
        <FlexRow>
          <FlexColumn style={{width: '50%'}}>
            ...
            />
            <div style={{color: colors.danger}}>{!isAddInstitution && errors && errors.displayName}</div>
            ...
            {institution.duaTypeEnum === DuaType.RESTRICTED && <FlexColumn style={{width: '16rem'}}>
              ...
              {this.state.invalidEmailAddress && <div style={{color: colors.danger}}>
                {this.state.invalidEmailAddressMsg}
                </div>}
            </FlexColumn>}
            {institution.duaTypeEnum === DuaType.MASTER && <FlexColumn style={{width: '16rem'}}>
              ...
              {this.state.invalidEmailDomain && <div style={{color: colors.danger}}>
                {this.state.invalidEmailDomainsMsg}
                </div>}
            </FlexColumn>}
          </FlexColumn>
          <FlexColumn style={{width: '50%', marginRight: '1rem'}}>
            <label style={{...styles.label, marginTop: '0rem'}}>User instruction</label>
            <TextArea
                id={'areaOfResearch'}
