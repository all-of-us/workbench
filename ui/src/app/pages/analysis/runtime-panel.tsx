  ...
  return <Fragment>
    <div style={styles.confirmWarning}>
      <div style={{display: 'flex', justifyContent: 'center'}}>
        <ExclamationTriangleIcon style={{color: colors.warning, gridColumn: 1, gridRow: 1}} className='is-solid' size='20'/>
      </div>
...
export const ConfirmDeleteUnattachedPD = ({onConfirm, onCancel}) => {
  ...
  return <Fragment>
    <div style={{display: 'flex',  marginRight: '0.5rem'}}>
      <ExclamationTriangleIcon style={{color: colors.warning, marginRight: '0.25rem'}} className='is-solid' size='20'/>
