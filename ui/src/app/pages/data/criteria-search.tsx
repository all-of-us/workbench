...
export class CriteriaSearch extends React.Component<Props, State>  {
  ...
  render() {
    ...
    const {autocompleteSelection, groupSelections, hierarchyNode, loadingSubtree, selectedIds, treeSearchTerms, growlVisible} = this.state;
    return <div>
      {loadingSubtree && <SpinnerOverlay/>}
      <div style={loadingSubtree ? {height: '100%', minHeight: '15rem', pointerEvents: 'none', opacity: 0.3} : {height: '100%', minHeight: '15rem'}}>
       <style>{css}</style>
