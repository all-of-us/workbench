...
// TODO remove before merging as this will be generated by codegen
enum ChartType {
  GENDER = 'GENDER',
...
export const ListOverview = fp.flow(
  ...
  class extends React.Component<Props, State> {
    ...
    get chartTypeItems() {
      return [
        {
          label: ChartType.ETHNICITY,
          command: () =>
            this.setState({ chartType: ChartType.ETHNICITY }),
        },
        {
          label: ChartType.RACE,
          command: () =>
            this.setState({ chartType: ChartType.RACE }),
        },
        {
          label: genderOrSexTypeToText(GenderOrSexType.GENDER),
          command: () =>
            this.setState({ chartType: ChartType.GENDER }),
        },
        {
          label: genderOrSexTypeToText(GenderOrSexType.SEXATBIRTH),
          command: () =>
            this.setState({ chartType: ChartType.SEXATBIRTH }),
        },
      ];
    }
                  ...
                  {refreshing ? (
                    ...
                    <React.Fragment>
                      <div style={styles.cardHeader}>
                        {currentGraphOptions.chartType.toString()}
                      </div>
