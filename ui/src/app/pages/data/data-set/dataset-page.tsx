        ...
        default:
          return <FlexRow style={styles.errorMessage}>
            ...
            <div style={{paddingLeft: '0.25rem'}}>
              ...
              some queries take longer to load. If the error keeps happening, please <AoULink style={{
                display: 'inline-block'}} onClick={() => this.openZendeskWidget()}>contact us</AoULink>. You can also
              ...
              <div style={{display: 'flex', backgroundColor: colors.white,
                ...
                <div style={{width: '55%'}}>
                  ...
                  {selectedDomains.size > 0 && <FlexRow style={{
                    ...
                    alignItems: 'center'}}>
                    <StyledExternalLink href={supportUrls.dataDictionary}>
                      Learn more
