...
import {dataUseAgreementStyles} from 'app/pages/profile/data-use-agreement-styles';
...
import {BolderHeader, BoldHeader, Header} from 'app/components/headers';
              ...
              <FlexColumn>
                ...
                <div>
                  My work, including any external data, files, or software I upload into the
                   Researcher Workbench, may be logged and monitored by the <i>All of Us</i>
                ...
                <label>Authorized Data user Name</label>
                <TextInput
                    disabled
                ...
                />
                <label>Date</label>
                <TextInput type='text' disabled value={new Date().toLocaleDateString()}/>
              </FlexColumn>
              <FlexRow style={styles.dataUserCodeOfConductFooter}>
                <Button
                    type={'link'}
