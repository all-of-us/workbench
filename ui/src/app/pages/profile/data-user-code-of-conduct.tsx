          ...
          {page === DataUserCodeOfConductPage.CONTENT && (
            <React.Fragment>
              ...
              <FlexRow style={styles.dataUserCodeOfConductFooter}>
                ...
                to sign the Data User Code of Conduct.
                <Button
                  type={'link'}
            ...
            <React.Fragment>
              <FlexColumn>
                ...
                <div style={{ ...styles.bold, ...styles.smallTopMargin }}>
                  ...
                  />
                  ("Authorized Data User") have personally reviewed this Data
                  User Code of Conduct. I agree to follow each of the policies
                ...
                >
                  My work, including any external data, files, or software I
                  upload into the Researcher Workbench, will be logged and
                  monitored by the <AoU /> Research Program to ensure compliance
                  with policies and procedures.
                </InitialsAgreement>
                <InitialsAgreement
                  onChange={(v) => this.setState({ initialPublic: v })}
                >
                  My name, affiliation, profile information and research
                  description will be made public. My research description will
                ...
                <div style={{ ...styles.bold, ...styles.smallTopMargin }}>
                  ...
                  termination of my <AoU /> Research Program account and/or
                  other sanctions, including, but not limited to:
                </div>
                <ul style={{ ...styles.bold, ...styles.smallTopMargin }}>
                  <li>
                    the posting of my name and affiliation on a publicly
                    accessible list of violators, and
                  </li>
                  <li>
                ...
                <div style={{ ...styles.bold, ...styles.smallTopMargin }}>
                  I understand that failure to comply with these requirements
                  may also carry financial or legal repercussions. Any misuse of
                  the <AoU /> Research Hub, Researcher Workbench or data
                  resources is taken very seriously, and other sanctions may be
                  sought.
                </div>
