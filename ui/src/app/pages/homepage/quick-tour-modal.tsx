...
export const panels = [
  {
    ...
    content: (
      <div>
        ...
        “Notebooks,” the analysis environment. <br />
        <br />
        For illustration, let's consider research on 'Type 2 diabetes' for this
        quick tour.
      </div>
    ),
    image: homepage,
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <br />
        <br />
        For example, you can build a Cohort called “diabetes cases,” to include
        people who have been diagnosed with type II diabetes, using a
        combination of billing codes and laboratory values. You can also have a
        “controls” Cohort. Once you build your cohorts, you can go through and
        manually review the records for each participant and decide if you want
        to include or exclude them from your Cohort and make specific
  ...
  },
  {
    ...
    content: (
      <div>
        Datasets are analysis-ready tables that can be exported to a Notebook.
        You can build and preview a dataset for one or more cohorts by selecting
        the desired concept sets and values for the cohorts.
        <br />
        <br />
        For example, select your cohort called “diabetes cases” and your concept
        set called “biometrics” and then the values from the concept set you
        want to see. Before exporting the dataset, you can preview the resulting
        data frame that will be sent to the notebook.
      </div>
    ),
    image: datasets,
  },
...
export class QuickTourReact extends React.Component<
  QuickTourReactProps,
  QuickTourReactState
> {
    ...
    return fullImage ? (
      ...
      <React.Fragment>
        ...
        <FlexColumn
          ...
          data-test-id='quick-tour-react'
          className='quickTourReact'
        >
                ...
                so setting a width would offset the entire selection area by half a connector length*/}
                  ...
                  >
                    <div
                      style={
                        selected
                          ? completedStyles.circleCompleted
                          : styles.circle
                      }
                    ...
                    {i !== panels.length - 1 && (
                      <div
                        style={
                          i < selected
                            ? completedStyles.connectorCompleted
                            : styles.connector
                        }
                      ></div>
                    )}
          ...
          >
            ...
            >
              <div style={styles.panelTitle} data-test-id='panel-title'>
            ...
            >
              ...
              >
                ...
                <Button
                  type='secondaryOnDarkBackground'
                  data-test-id='next'
