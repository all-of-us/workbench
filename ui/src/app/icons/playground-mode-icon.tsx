...
export const PlaygroundModeIcon = () => <svg version='1.1'
      ...
      <g id='Group-5' transform='translate(363.000000, 85.000000)'>
        <g id='Group-3' transform='translate(0.889808, 0.297292)'>
          <g id='Group' transform='translate(0.047675, 0.625027)'>
            <path fill='#216FB4' d={`M11.8-0.9c0.7,0,1.3,0.6,1.3,1.3V10c0,0.7-0.6,1.3-1.3,1.3H0.4c
  ...
  <g>
    ...
    ,0.1-0.3,0L3.2,8.4c-0.1-0.1-0.1-0.2,0-0.3l0.5-0.5c0.1-0.1,0.2-0.1,0.3,0l1.7,1.7l4.8-4
    .8C10.6,4.5,10.8,4.5,10.8,4.6z`}/>
  </g>
</svg>;
