...
const hoverStyle = {
  ...defaultStyle,
  fill: colorWithWhiteness(colors.accent, 0.2),
};
...
export class EditComponentReact extends React.Component<
  EditComponentProps,
  EditComponentState
> {
  ...
  render() {
    return (
      <svg
        style={
          this.props.disabled
            ? { ...this.state.style, ...disabledStyle }
            : this.state.style
        }
        version='1.1'
        viewBox='0 0 36 36'
      ...
      >
        <title>Edit</title>
        <path
          d='M4.22,23.2l-1.9,8.2a2.06,2.06,0,0,0,2,2.5,2.14,2.14,0,0,0,.43,0L13,32,28.84,16.22,
                 20,7.4Z'
        />
        <path
          d='M33.82,8.32l-5.9-5.9a2.07,2.07,0,0,0-2.92,0L21.72,5.7l8.83,8.83,3.28-3.28A2.07,
