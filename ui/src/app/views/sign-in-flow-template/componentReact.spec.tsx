...
describe('RegistrationPageTemplateReact', () => {
  ...
  it('should display login background image and directive by default', () => {
    ...
    const templateImage = wrapper.find('div').find({id: 'imgTemplate'});
    ...
    expect(wrapper.find('div').find({id: 'login'})).toBeTruthy();
  });
  ...
  it('should display small background image when window width is between 900 and 1300', () => {
    ...
    expect(wrapper.find('div').find({id: 'invitation'})).toBeTruthy();
  });
