...
import {reactStyles, ReactWrapperBase, summarizeErrors, withUserProfile} from 'app/utils';
...
const IndentedUl = (props) => {
  return <ul style={{marginLeft: '1rem'}}>{props.children}</ul>;
};

const DataUseAgreementText = () => {
  return <div>
    <BolderHeader>All of Us Research Program - Data Use Agreement</BolderHeader>
    <div>This data use agreement describes how <i>All of Us</i> Research Program data can and cannot be
      used.
    </div>
    ...
    <div>Before they access and/or work with <i>All of Us</i> Research Program data, authorized users
      must:
      <ol>
    ...
    <SecondHeader>As “Authorized User” of the <i>All of Us</i> Research Program data, I
      will:</SecondHeader>
    <IndentedUl>
      <li>read and adhere to the <i>All of Us</i> Research Program <a target='_blank' href="https://docs.google.com/document/d/1UG3soAONYE0prmhMgleBIoO8fl3Gh5THIPLeoJzaTmc/edit">core values</a>.</li>
      <li>know and follow all applicable US federal, state, and local (applicable in the area where
        I
        am conducting research) laws regarding research involving human data and data privacy.
      </li>
      <li>respect the privacy of research participants at all times.
        <IndentedUl>
          <li>I <strong>will <strong>NOT</strong> use</strong> or disclose any information that directly identifies
            one or more participants.
          </li>
          <li>If I become aware of any information that directly identifies one or more
            participants, I
            will notify the <i>All of Us</i> Research Program immediately using the automatic notification
            system.
          </li>
          <li>I <strong>will <strong>NOT</strong> attempt</strong> to re-identify research participants or their relatives.</li>
          <li>If I unintentionally re-identify participants through the process of my work, I will
            contact
            the <i>All of Us</i> Research Program immediately using the automatic notification system.
          </li>
          <li>If I become aware of any uses or disclosures of <i>All of Us</i> Research Program data that
            could
            endanger the security or privacy of research participants, I will contact the <i>All of Us</i>
            Research Program immediately using the automatic notification system.
          </li>
        </IndentedUl>
      </li>
      <li>provide a meaningful and accurate description of my research purpose every time I create
        an
        <i>All of Us</i> Research Program workspace.
        <IndentedUl>
          <li>Within each workspace, I will use the data for the research purpose I have provided.
          </li>
      ...
      <li>use a version of the <i>All of Us</i> Research Program database that is current at or after the
        time
        my analysis begins
        <IndentedUl>
      ...
      <li>honor the contribution of those who take part in <i>All of Us</i> to my work
        <IndentedUl>
          <li>I will acknowledge the <i>All of Us</i> Research Program and its research participants in all
            oral
            and written presentations, disclosures, and publications resulting from any analyses of
            the
            data.
            <IndentedUl>
              <li>
                ...
                on data
                contributed by participants to the <i>All of Us</i> Research Program, managed by the
                National
                Institutes of Health. Information about the <i>All of Us</i> Research Program can be found
          ...
          <li>I will deposit an electronic version of final, peer-reviewed manuscript on National
            Library
            of Medicine's PubMed Central no later than 3 months after the official date of
            publication.
          </li>
        </IndentedUl>
      </li>
    ...
    <IndentedUl>
      <li><strong>NOT</strong> share my login information with anyone.
        <IndentedUl>
          <li>I will not share my login information with another authorized user of the
      ...
      <li>
        <strong>NOT</strong> use <i>All of Us</i> Research Program data for research that is discriminatory or stigmatizing
        of individuals, families, or communities. Please review the <i>All of Us</i> policy on stigmatizing
        research here.
        <IndentedUl>
          <li>I will contact the <i>All of Us</i> Research Program Resource Access Board (RAB) for further
            guidance on this point as needed.
          </li>
        </IndentedUl>
      </li>
      <li><strong>NOT</strong> attempt to contact <i>All of Us</i> Research Program participants.</li>
      <li><strong>NOT</strong> make copies of or download individual-level data outside of the <i>All of Us</i> Research
        Program environment without approval from RAB.
        <IndentedUl>
          <li>I will not take screenshots or attempt any other way of copying individual-level
            data.
          </li>
        </IndentedUl>
      </li>

      <li><strong>NOT</strong> redistribute or publish registered access or controlled tier <i>All of Us</i> Research
        Program
        data including aggregate statistics that are more granular than buckets of 20 without
        approval
        from the RAB.
      </li>
      <li><strong>NOT</strong> attempt to link registered or controlled tier <i>All of Us</i> Research Program data at the
        individual level with data from other sources without explicit permission from RAB.
      </li>
      <li><strong>NOT</strong> use <i>All of Us</i> Research Program data for marketing purposes.
        <IndentedUl>
          <li>“Marketing” means a communication about a product or service that encourages
            recipients of
            the communication to purchase or use the product or service (US 45 CFR §164.501).
          </li>
        </IndentedUl>
      </li>
      <li><strong>NOT</strong> represent that the <i>All of Us</i> Research Program endorses or approves of my research
        unless
        such endorsement is expressly provided by the RAB.
      </li>
    </IndentedUl>

    <SecondHeader>Data Disclaimer:</SecondHeader>
    <div>The <i>All of Us</i> Research Program does not guarantee the accuracy of the data in the <i>All of Us</i>
      Research Program database. The <i>All of Us</i> Research Program does not guarantee the performance
      of the software in the <i>All of Us</i> Research Program database. The <i>All of Us</i> Research Program
      does not warrant or endorse the research results obtained by using the <i>All of Us</i> database.
    </div>
  </div>;
};
...
export const DataUseAgreement = withUserProfile()(class extends React.Component<
    ...
    return <div style={styles.dataUseAgreementPage}>
      ...
      <div style={{
        ...
        <InitialsAgreement onChange={(v) => this.setState({initialName: v})} value={initialName}>
          ...
          description will be used by the <i>All of Us</i> Research Program to provide participants
          with meaningful information about the research being conducted.
        </InitialsAgreement>
        <InitialsAgreement onChange={(v) => this.setState({initialSanctions: v})}
                           value={initialSanctions}>
          I have read and understand the <i>All of Us</i> Research Program Sanctions for Privacy and
        ...
        <TooltipTrigger content={errors && 'All fields required'}>
          <Button style={{marginTop: '1rem', cursor: errors && 'not-allowed', padding: '0 1.3rem'}}
