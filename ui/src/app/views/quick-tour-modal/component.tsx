...
const panels = [
    {
      title: "Intro",
      content: <div>Welcome to the All of Us Research Workbench!<br></br><br></br>All workbench analyses
        ...
        you make can then be accessed from “Notebooks,” the analysis environment. <br></br><br></br>
    ...
    },
    {
      ...
      content: <div>A Workspace is your place to store and analyze data for a specific project.
       ...
       your work. The dataset referenced by a workspace is in
        ...
        <a className="link" href="https://www.ohdsi.org/past-events/2017-tutorials-omop-common-data-model-and-standardized-vocabularies/" target="_blank"> tutorials</a>
