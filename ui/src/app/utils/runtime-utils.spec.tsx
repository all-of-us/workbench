...
import {findMostSevereDiffState,RuntimeDiffState, useCustomRuntime} from 'app/utils/runtime-utils';
...
describe('runtime-utils', () => {
  ...
  test.each([
    [[], undefined],
    [[RuntimeDiffState.NEEDS_DELETE_RUNTIME], RuntimeDiffState.NEEDS_DELETE_RUNTIME],
    [
      [
