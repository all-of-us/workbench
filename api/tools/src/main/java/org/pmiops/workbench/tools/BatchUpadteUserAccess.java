...
/** Updates user tier access, and sync with Terra to remove user from auth domains.*/
@Configuration
public class BatchUpadteUserAccess {
  ...
  private static final Logger log =
      Logger.getLogger(BatchUpadteUserAccess.class.getName());
  ...
  public static void main(String[] args) {
    CommandLineToolConfig.runCommandLine(
        BatchUpadteUserAccess.class, args);
  }
}
