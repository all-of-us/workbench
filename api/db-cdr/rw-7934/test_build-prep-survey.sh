...
export BQ_PROJECT=all-of-us-workbench-test         # CDR project
export BQ_DATASET=chenchals_survey_refactor         # CDR dataset
export FILE_NAME=cope_staged.csv          # Filename to process
export ID=13000                 # Starting id position


BUCKET="all-of-us-workbench-private-cloudsql"
SCHEMA_PATH="generate-cdr/bq-schemas"
TEMP_FILE_DIR="csv_old"
...
TBL_TEMP_PS="prep_temp_prep_survey_old_"$ID
...
bq load --project_id="$BQ_PROJECT" --source_format=CSV "$BQ_DATASET.$TBL_TEMP_PS" \
