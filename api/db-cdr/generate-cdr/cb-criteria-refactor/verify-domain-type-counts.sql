...
select * from (
                  select '01-sequential' run_type, domain_id, type, is_group, 'pm-concept-name' name, count(is_group) sum_grp_count
                       , sum(item_count) sum_item_count, sum(rollup_count) sum_rollup_count, sum(est_count) sum_est_count
                  ...
                  union all
                  select '02-parallel' run_type, domain_id, type, is_group, 'pm-concept-name' name, count(is_group) sum_grp_count
                          , sum(item_count) sum_item_count, sum(rollup_count) sum_rollup_count, sum(est_count) sum_est_count
                  ...
                  union all
                  select '03-parallel-multi' run_type, domain_id, type, is_group, 'pm-concept-name' name, count(is_group) sum_grp_count
                          , sum(item_count) sum_item_count, sum(rollup_count) sum_rollup_count, sum(est_count) sum_est_count
                  ...
                  union all
                  select '10-original' run_type, domain_id, type, is_group, 'pm-concept-name' name, count(is_group) sum_grp_count
                          , sum(item_count) sum_item_count, sum(rollup_count) sum_rollup_count, sum(est_count) sum_est_count
                  ...
                  union all
                  select '20-std-src' run_type, domain_id, type, is_group, 'pm-concept-name' name, count(is_group) sum_grp_count
                          , sum(item_count) sum_item_count, sum(rollup_count) sum_rollup_count, sum(est_count) sum_est_count
