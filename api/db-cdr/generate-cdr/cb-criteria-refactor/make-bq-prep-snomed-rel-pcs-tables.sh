...
#5421- #5451 : prep_snomed_rel_pcs : make-bq-criteria-tables.sh
...
###############################################
#5452 - #5509 : prep_snomed_rel_pcs_in_data : make-bq-criteria-tables.sh
#       Uses tables: procedure_occurrence, concept, prep_snomed_rel_pcs
