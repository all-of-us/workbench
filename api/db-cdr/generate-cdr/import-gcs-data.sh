...
TABLES=(achilles_results achilles_results_dist domain_info survey_module domain vocabulary cb_criteria cb_criteria_attribute cb_criteria_relationship cb_criteria_ancestor concept concept_relationship concept_synonym domain_vocabulary_info)
