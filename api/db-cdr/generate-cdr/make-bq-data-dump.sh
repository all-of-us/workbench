...
tables=(concept concept_relationship cb_criteria_relationship cb_criteria cb_criteria_attribute domain_info survey_module domain vocabulary cb_criteria_ancestor concept_synonym cb_person)
