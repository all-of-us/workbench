...
tables=(cb_survey_attribute cb_survey_version cb_criteria_relationship cb_criteria cb_criteria_attribute ds_linking ds_data_dictionary domain_info domain_card survey_module cb_criteria_ancestor cb_person cb_data_filter cb_criteria_menu cb_menu)
