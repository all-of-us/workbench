...
tables=(concept concept_relationship criteria_relationship criteria criteria_attribute domain_info survey_module domain vocabulary criteria_ancestor concept_synonym domain_vocabulary_info)
