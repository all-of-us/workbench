...
tables=(cb_survey_attribute cb_survey_version concept cb_criteria_relationship cb_criteria cb_criteria_attribute ds_linking domain_info survey_module domain vocabulary cb_criteria_ancestor concept_synonym cb_person cb_data_filter)
...
for table in ${tables[@]}; do
  ...
  if [[ $table =~ ^(concept|concept_synonym|cb_criteria|cb_person)$ ]]
  then
