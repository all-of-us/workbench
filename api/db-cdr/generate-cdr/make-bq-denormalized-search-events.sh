...
SELECT p.person_id,
    ...
    'Procedure' as domain,
    DATE_DIFF(po.procedure_date,date(p.year_of_birth, p.month_of_birth, p.day_of_birth), YEAR) - IF(EXTRACT(MONTH FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth))*100 + EXTRACT(DAY FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth)) > EXTRACT(MONTH FROM po.procedure_date)*100 + EXTRACT(DAY FROM po.procedure_date),1,0) as age_at_event,
    vo.visit_concept_id,
    vo.visit_occurrence_id
...
SELECT p.person_id,
    ...
    'Observation' as domain,
    DATE_DIFF(o.observation_date,date(p.year_of_birth, p.month_of_birth, p.day_of_birth), YEAR) - IF(EXTRACT(MONTH FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth))*100 + EXTRACT(DAY FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth)) > EXTRACT(MONTH FROM o.observation_date)*100 + EXTRACT(DAY FROM o.observation_date),1,0) as age_at_event,
    vo.visit_concept_id,
    vo.visit_occurrence_id,
    o.value_as_number,
...
SELECT p.person_id,
    ...
    'Drug' as domain,
    DATE_DIFF(d.drug_exposure_start_date,date(p.year_of_birth, p.month_of_birth, p.day_of_birth), YEAR) - IF(EXTRACT(MONTH FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth))*100 + EXTRACT(DAY FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth)) > EXTRACT(MONTH FROM d.drug_exposure_start_date)*100 + EXTRACT(DAY FROM d.drug_exposure_start_date),1,0) as age_at_event,
    vo.visit_concept_id,
    vo.visit_occurrence_id
...
SELECT p.person_id,
    ...
    'Visit' as domain,
    DATE_DIFF(v.visit_start_date,date(p.year_of_birth, p.month_of_birth, p.day_of_birth), YEAR) - IF(EXTRACT(MONTH FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth))*100 + EXTRACT(DAY FROM date(p.year_of_birth, p.month_of_birth, p.day_of_birth)) > EXTRACT(MONTH FROM v.visit_start_date)*100 + EXTRACT(DAY FROM v.visit_start_date),1,0) as age_at_event,
    v.visit_concept_id,
