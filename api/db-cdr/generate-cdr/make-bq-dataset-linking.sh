...
VALUES
    ...
    ('CONDITION_START_DATETIME', 'CONDITION_START_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ('CONDITION_END_DATETIME', 'CONDITION_END_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ('CONDITION_TYPE_CONCEPT_ID', 'CONDITION_TYPE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ...
    ('STOP_REASON', 'STOP_REASON', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ...
    ('CONDITION_SOURCE_VALUE', 'CONDITION_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ('CONDITION_SOURCE_CONCEPT_ID', 'CONDITION_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ...
    ('CONDITION_STATUS_SOURCE_VALUE', 'CONDITION_STATUS_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
    ('CONDITION_STATUS_CONCEPT_ID', 'CONDITION_STATUS_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.condition_occurrence\` c_occurrence', 'Condition'),
...
VALUES
    ...
    ('DRUG_CONCEPT_ID', 'DRUG_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ...
    ('DRUG_EXPOSURE_START_DATETIME', 'DRUG_EXPOSURE_START_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('DRUG_EXPOSURE_END_DATETIME', 'DRUG_EXPOSURE_END_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('VERBATIM_END_DATE', 'VERBATIM_END_DATE', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('DRUG_TYPE_CONCEPT_ID', 'DRUG_TYPE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ...
    ('STOP_REASON', 'STOP_REASON', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('REFILLS', 'REFILLS', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('QUANTITY', 'QUANTITY', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('DAYS_SUPPLY', 'DAYS_SUPPLY', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('SIG', 'SIG', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('ROUTE_CONCEPT_ID', 'ROUTE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ...
    ('LOT_NUMBER', 'LOT_NUMBER', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ...
    ('DRUG_SOURCE_VALUE', 'DRUG_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('DRUG_SOURCE_CONCEPT_ID', 'DRUG_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ...
    ('ROUTE_SOURCE_VALUE', 'ROUTE_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug'),
    ('DOSE_UNIT_SOURCE_VALUE', 'DOSE_UNIT_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.drug_exposure\` d_exposure', 'Drug')"
...
VALUES
    ...
    ('MEASUREMENT_CONCEPT_ID', 'MEASUREMENT_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('MEASUREMENT_DATETIME', 'MEASUREMENT_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ('MEASUREMENT_TYPE_CONCEPT_ID', 'MEASUREMENT_TYPE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('OPERATOR_CONCEPT_ID', 'OPERATOR_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('VALUE_AS_NUMBER', 'VALUE_AS_NUMBER', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ('VALUE_AS_CONCEPT_ID', 'VALUE_AS_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('UNIT_CONCEPT_ID', 'UNIT_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('RANGE_LOW', 'RANGE_LOW', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ('RANGE_HIGH', 'RANGE_HIGH', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('MEASUREMENT_SOURCE_VALUE', 'MEASUREMENT_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ('MEASUREMENT_SOURCE_CONCEPT_ID', 'MEASUREMENT_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ...
    ('UNIT_SOURCE_VALUE', 'UNIT_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement'),
    ('VALUE_SOURCE_VALUE', 'VALUE_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.measurement\` measurement', 'Measurement')"
...
VALUES
    ...
    ('OBSERVATION_CONCEPT_ID', 'OBSERVATION_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ...
    ('OBSERVATION_DATETIME', 'OBSERVATION_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('OBSERVATION_TYPE_CONCEPT_ID', 'OBSERVATION_TYPE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ...
    ('VALUE_AS_NUMBER', 'VALUE_AS_NUMBER', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('VALUE_AS_STRING', 'VALUE_AS_STRING', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('VALUE_AS_CONCEPT_ID', 'VALUE_AS_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ...
    ('QUALIFIER_CONCEPT_ID', 'QUALIFIER_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ...
    ('UNIT_CONCEPT_ID', 'UNIT_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ...
    ('OBSERVATION_SOURCE_VALUE', 'OBSERVATION_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('OBSERVATION_SOURCE_CONCEPT_ID', 'OBSERVATION_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ...
    ('UNIT_SOURCE_VALUE', 'UNIT_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('QUALIFIER_SOURCE_VALUE', 'QUALIFIER_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('value_source_concept_id', 'value_source_concept_id', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('value_source_value', 'value_source_value', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),
    ('questionnaire_response_id', 'questionnaire_response_id', 'from \`$BQ_PROJECT.$BQ_DATASET.ds_observation\` observation', 'Observation'),"


person.echo "ds_linking - inserting person data"

bq --quiet --project=$BQ_PROJECT query --nouse_legacy_sql \
"INSERT INTO \`$BQ_PROJECT.$BQ_DATASET.ds_linking\`
VALUES
    ('PERSON_ID', 'PERSON_ID', 'FROM \`$BQ_PROJECT.$BQ_DATASET.person\` person', 'Person'),
    ('GENDER_CONCEPT_ID', 'GENDER_CONCEPT_ID', 'FROM \`$BQ_PROJECT.$BQ_DATASET.person\` person', 'Person'),
    ...
    ('DATE_OF_BIRTH', 'BIRTH_DATETIME as DATE_OF_BIRTH', 'FROM \`$BQ_PROJECT.$BQ_DATASET.person\` person', 'Person'),
    ('RACE_CONCEPT_ID', 'RACE_CONCEPT_ID', 'FROM \`$BQ_PROJECT.$BQ_DATASET.person\` person', 'Person'),
    ...
    ('ETHNICITY_CONCEPT_ID', 'ETHNICITY_CONCEPT_ID', 'FROM \`$BQ_PROJECT.$BQ_DATASET.person\` person', 'Person'),
...
VALUES
    ...
    ('PROCEDURE_CONCEPT_ID', 'PROCEDURE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ...
    ('PROCEDURE_DATETIME', 'PROCEDURE_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ('PROCEDURE_TYPE_CONCEPT_ID', 'PROCEDURE_TYPE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ...
    ('MODIFIER_CONCEPT_ID', 'MODIFIER_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ...
    ('QUANTITY', 'QUANTITY', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ...
    ('PROCEDURE_SOURCE_VALUE', 'PROCEDURE_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ('PROCEDURE_SOURCE_CONCEPT_ID', 'PROCEDURE_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure'),
    ...
    ('QUALIFIER_SOURCE_VALUE', 'QUALIFIER_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` procedure', 'Procedure')"
...
VALUES
    ...
    ('VISIT_CONCEPT_ID', 'VISIT_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ...
    ('VISIT_START_DATETIME', 'VISIT_START_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ('VISIT_END_DATETIME', 'VISIT_END_DATETIME', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ('VISIT_TYPE_CONCEPT_ID', 'VISIT_TYPE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ...
    ('VISIT_SOURCE_VALUE', 'VISIT_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ('VISIT_SOURCE_CONCEPT_ID', 'VISIT_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ...
    ('ADMITTING_SOURCE_CONCEPT_ID', 'ADMITTING_SOURCE_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ...
    ('ADMITTING_SOURCE_VALUE', 'ADMITTING_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ('DISCHARGE_TO_CONCEPT_ID', 'DISCHARGE_TO_CONCEPT_ID', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit'),
    ...
    ('DISCHARGE_TO_SOURCE_VALUE', 'DISCHARGE_TO_SOURCE_VALUE', 'from \`$BQ_PROJECT.$BQ_DATASET.procedure_occurrence\` visit', 'Visit’)"