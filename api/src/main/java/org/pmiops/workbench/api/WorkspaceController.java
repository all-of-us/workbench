...
public class WorkspaceController implements WorkspacesApiDelegate {
      ...
      new Function<org.pmiops.workbench.db.model.Workspace, Workspace>() {
        ...
        public Workspace apply(org.pmiops.workbench.db.model.Workspace workspace) {
          ...
          Workspace result = new Workspace()
              ...
              .dataAccessLevel(DataAccessLevelEnum.fromValue(workspace.getDataAccessLevel().name()))
              .name(workspace.getName())
              .id(workspaceId.getWorkspaceId())
              .namespace(workspaceId.getNamespace())
  ...
  public ResponseEntity<Workspace> createWorkspace(Workspace workspace) {
    org.pmiops.workbench.db.model.Workspace existingWorkspace =
        getDbWorkspace(workspace.getNamespace(), workspace.getId());
    if (existingWorkspace != null) {
      throw new BadRequestException("Workspace with name {0} already exists"
          .format(existingWorkspace.getFirecloudName()));
    }
  ...
  private org.pmiops.workbench.db.model.Workspace getDbWorkspace(String workspaceNamespace,
      String workspaceId) {
    String firecloudName = org.pmiops.workbench.db.model.Workspace
        .toFirecloudName(workspaceNamespace, workspaceId);
    org.pmiops.workbench.db.model.Workspace existingWorkspace =
        workspaceDao.findByFirecloudName(firecloudName);
