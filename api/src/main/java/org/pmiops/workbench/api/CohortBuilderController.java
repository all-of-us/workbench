  ...
  public ResponseEntity<CriteriaListResponse> findCriteriaByDomainAndSearchTerm(Long cdrVersionId,
    ...
    if (DomainType.DRUG.equals(DomainType.fromValue(domain))) {
      ...
      if (!conceptIds.isEmpty()) {
        List<Integer> relationshipConceptIds = cbCriteriaDao.findDrugConceptId2ByConceptId1(conceptIds);
        ingredients = cbCriteriaDao.findDrugIngredientByConceptId(
            relationshipConceptIds
              .stream()
              .map(c -> String.valueOf(c))
              .collect(Collectors.toList()), domain, CriteriaType.RXNORM.toString()
          );
      }
      criteriaList = Stream
