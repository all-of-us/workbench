...
public class CohortBuilderController implements CohortBuilderApiDelegate {
     ...
     */
    private static final Function<List<Criteria>, List<org.pmiops.workbench.model.Criteria>>
            TO_CLIENT_CRITERIA =
            new Function<List<Criteria>, List<org.pmiops.workbench.model.Criteria>>() {
                @Override
                public List<org.pmiops.workbench.model.Criteria> apply(List<Criteria> criteriaList) {
                    List<org.pmiops.workbench.model.Criteria> returnList
                            = new ArrayList<>();
                    for (Criteria criteria : criteriaList) {
                        returnList.add(new org.pmiops.workbench.model.Criteria()
                                .id(criteria.getId())
