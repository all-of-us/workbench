...
public class CohortReviewController implements CohortReviewApiDelegate {
   ...
   */
  private static final Function<DbParticipantCohortStatus, ParticipantCohortStatus>
  ...
  private String getName(List<DbCriteria> criteriaList, Long conceptId) {
    List<DbCriteria> returnList =
        criteriaList.stream()
