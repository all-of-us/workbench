...
public class CohortReviewController implements CohortReviewApiDelegate {
   ...
   * @param creator
   */
  private DbCohortReview initializeCohortReview(Long cdrVersionId, DbCohort cohort, User creator) {
  ...
  private DbCohortReview createNewCohortReview(
      DbCohort cohort, Long cdrVersionId, Long cohortCount, User creator) {
