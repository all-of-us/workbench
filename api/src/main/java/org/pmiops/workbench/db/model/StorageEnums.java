  ...
  private static final BiMap<UnderservedPopulationEnum, Short>
      CLIENT_TO_STORAGE_UNDERSERVED_POPULATION =
          ImmutableBiMap.<UnderservedPopulationEnum, Short>builder()
              ...
              .put(
                  UnderservedPopulationEnum.SEXUAL_ORIENTATION_DOES_NOT_THINK_OF_HAVING_SEXUALITY,
                  (short) 21)
              ...
              .put(
                  UnderservedPopulationEnum.EDUCATION_INCOME_LESS_THAN_HIGH_SCHOOL_GRADUATE,
                  (short) 38)
              .put(
                  UnderservedPopulationEnum
