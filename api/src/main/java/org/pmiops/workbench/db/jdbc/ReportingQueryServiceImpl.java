    ...
    return jdbcTemplate.query(
        String.format(
            "SELECT \n"
                ...
                + "             GROUP_CONCAT(DISTINCT dec.ethnic_category) as ethnic_category, "
                + "             GROUP_CONCAT(DISTINCT dgi.gender_identity) as gender_identity, "
                + "             GROUP_CONCAT(DISTINCT dso.sexual_orientation) as sexual_orientation "
                + "       FROM demographic_survey_v2 as dsv2 "
                + "         LEFT OUTER JOIN demographic_survey_v2_ethnic_category as dec "
                + "             ON dsv2.demographic_survey_v2_id = dec.demographic_survey_v2_id\n"
                + "         LEFT OUTER JOIN demographic_survey_v2_gender_identity as dgi "
                + "             ON dsv2.demographic_survey_v2_id = dgi.demographic_survey_v2_id\n"
                + "         LEFT OUTER JOIN demographic_survey_v2_sexual_orientation as dso "
                + "             ON dsv2.demographic_survey_v2_id = dso.demographic_survey_v2_id\n"
