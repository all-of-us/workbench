...
/**
 * While it's possible to mock this service correctly,
 * it's much less intrusive to simply provide a No-op fake
 * implementation. See
 * https://stackoverflow.com/questions/60138415/which-breaks-first-mockito-or-java-generics
 * for details on how to mock the generic supplier matcher.
 */
...
public class LogsBasedMetricServiceFakeImpl implements LogsBasedMetricService {
  ...
  @Override
  public void recordElapsedTime(Builder measurementBundleBuilder,
  ...
  @Override
  public <T> T recordElapsedTime(Builder measurementBundleBuilder,
