...
public class LeonardoCustomEnvVarUtils {
    ...
    private static
    final String MICROARRAY_HAIL_STORAGE_PATH_KEY = "MICROARRAY_HAIL_STORAGE_PATH";
    @VisibleForTesting
    public static final String WORKSPACE_CDR_ENV_KEY = "WORKSPACE_CDR";
    @VisibleForTesting
    ...
    @VisibleForTesting
    public static final Map<String, String> FASTA_REFERENCE_ENV_VAR_MAP = new ImmutableMap.Builder<String, String>()
            .put("HG38_REFERENCE_FASTA", "gs://genomics-public-data/references/hg38/v0/Homo_sapiens_assembly38.fasta")
            .put("HG38_REFERENCE_FAI", "gs://genomics-public-data/references/hg38/v0/Homo_sapiens_assembly38.fasta.fai")
            .put("HG38_REFERENCE_DICT", "gs://genomics-public-data/references/hg38/v0/Homo_sapiens_assembly38.dict").build();
        ...
        if (!Strings.isNullOrEmpty(datasetsBucket) && !Strings.isNullOrEmpty(bucketInfix)) {
            ...
            vars.putAll(
                    partialStoragePaths.entrySet().stream()
                            ...
                            .collect(
                                    Collectors.toMap(
                                            Map.Entry::getKey, entry -> joinStoragePaths(basePath, entry.getValue().get()))));
        }
    ...
    public static Map<String, String> getBaseEnvironmentVariables(DbWorkspace workspace, FireCloudService fireCloudService, WorkbenchConfig workbenchConfig) {
        ...
        customEnvironmentVariables.put(
                LEONARDO_BASE_URL, workbenchConfig.firecloud.leoBaseUrl);
