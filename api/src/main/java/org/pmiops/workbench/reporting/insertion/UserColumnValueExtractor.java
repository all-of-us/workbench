...
public enum UserColumnValueExtractor implements ColumnValueExtractor<ReportingUser> {
  ...
  AREA_OF_RESEARCH(
      "area_of_research", ReportingUser::getAreaOfResearch),
  ...
  CURRENT_POSITION(
      "current_position", ReportingUser::getCurrentPosition),
  DATA_ACCESS_LEVEL(
      "data_access_level",
  ...
  PROFESSIONAL_URL(
      "professional_url", ReportingUser::getProfessionalUrl),
  ...
  STREET_ADDRESS_1(
      "street_address_1", ReportingUser::getStreetAddress1),
  STREET_ADDRESS_2(
      "street_address_2", ReportingUser::getStreetAddress2),
  ZIP_CODE("zip_code", ReportingUser::getZipCode),
  INSTITUTION_ID(
      "institution_id", ReportingUser::getInstitutionId),
