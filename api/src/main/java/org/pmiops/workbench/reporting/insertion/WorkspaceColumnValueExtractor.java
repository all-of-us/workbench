...
public enum WorkspaceColumnValueExtractor implements ColumnValueExtractor<ReportingWorkspace> {
  ...
  CDR_VERSION_ID(
      "cdr_version_id", ReportingWorkspace::getCdrVersionId),
  CREATION_TIME(
      "creation_time",
  ...
  RP_CONTROL_SET(
      "rp_control_set", ReportingWorkspace::getRpControlSet),
  ...
  RP_EDUCATIONAL(
      "rp_educational", ReportingWorkspace::getRpEducational),
  ...
  RP_OTHER_PURPOSE(
      "rp_other_purpose", ReportingWorkspace::getRpOtherPurpose),
