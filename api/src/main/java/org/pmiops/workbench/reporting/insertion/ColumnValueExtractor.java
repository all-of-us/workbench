 ...
 */
public interface ColumnValueExtractor<MODEL_TYPE> {
  ...
  // on the model.
  Function<MODEL_TYPE, Object> getRowToInsertValueFunction();
  ...
  Function<MODEL_TYPE, QueryParameterValue> getQueryParameterValueFunction();
  ...
  default @Nullable Object getRowToInsertValue(@NotNull MODEL_TYPE model) {
  ...
  default @NotNull QueryParameterValue toParameterValue(@NotNull MODEL_TYPE model) {
