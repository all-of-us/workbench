...
/**
 * This enum maps specific implementations of {@link AbstractQueryBuilder} to specific criteria
 * types/searches. This enum is built specifically for use of the {@link
...
public enum FactoryKey {
  ...
  private static final Map<String, Object> typeMap =
  ...
  /**
   * {@link AbstractQueryBuilder} implementations will have a many to one relationship with the
   * criteria tree types. This map will only contain mappings for searching for subject/person data.
   * For example: ICD9, ICD10, CPT and SNOMED criteria will all map to the {@link
   * CodesQueryBuilder}.
   *
   * @return
   */
