...
public final class QueryBuilderConstants {
  ...
  public static final String ONE_OPERAND_MESSAGE =
      "Bad Request: {0} {1} must have one operand when using the {2} operator.";
  public static final String TWO_OPERAND_MESSAGE =
      "Bad Request: {0} {1} can only have 2 operands when using the {2} operator";
  public static final String OPERANDS_NUMERIC_MESSAGE =
      "Bad Request: {0} {1} operands must be numeric.";
  ...
  public static final String NOT_IN_MODIFIER_MESSAGE =
      "Bad Request: Modifier {0} must provide {1} operator.";
  public static final String AGE_DEC_MESSAGE =
      "Bad Request: Attribute Age and Deceased cannot be used together.";
  ...
  public static ImmutableMap<ModifierType, String> modifierText =
      ImmutableMap.<ModifierType, String>builder()
  ...
  public static ImmutableMap<Operator, String> operatorText =
