...
public interface CloudBillingClient {
   ...
   * Terra. Terra has background job that runs every 5s to update billing account for all
   * workspaces. We have to poll this from Google to verify the operation succeeds.
   */
