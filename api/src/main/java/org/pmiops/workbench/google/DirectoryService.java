...
public interface DirectoryService {
  ...
  // This has been added to backfill user data for Absorb. It can be deleted once the script is successfully run on Prod.
  User updateUser(User user);

  // This has been added to backfill user data for Absorb. It can be made private once the script is successfully run on Prod
