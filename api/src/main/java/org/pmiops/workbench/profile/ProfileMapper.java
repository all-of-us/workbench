...
public interface ProfileMapper {
  ...
  @Mapping(target = "latestTermsOfServiceTime", ignore = true) // handled by ProfileService.getProfile
  @Mapping(target = "latestTermsOfServiceVersion", ignore = true) // handled by ProfileService.getProfile
  @Mapping(target = "verifiedInstitutionalAffiliation", ignore = true) // handled by ProfileService.getProfile
  ...
  @Mapping(target = "clusterConfigDefault", ignore = true) // used only by ClusterController / LeonardoNotebooksClient
  @Mapping(target = "clusterConfigDefaultRaw", ignore = true) // used only by ClusterController / LeonardoNotebooksClient
  @Mapping(target = "clusterCreateRetries", ignore = true) // used only by ClusterController / LeonardoNotebooksClient
  @Mapping(target = "complianceTrainingExpirationTime", ignore = true) // handled by UserService.syncComplianceTraining[V1|V2]
  ...
  @Mapping(target = "firstRegistrationCompletionTime", ignore = true) // used only in UserService.updateDataAccessLevel
  @Mapping(target = "freeTierCreditsLimitDaysOverride", ignore = true) // unused
  @Mapping(target = "freeTierCreditsLimitDollarsOverride", ignore = true) // handled by FreeTierBillingService.getUserFreeTierDollarLimit
  ...
  @Mapping(target = "moodleId", ignore = true) // handled by UserService.syncComplianceTraining[V1|V2]
