...
public class CriteriaDaoTest {
  ...
  public void findCriteriaByParentId() throws Exception {
    Criteria icd9Criteria1 =
        createCriteria(
            TreeType.ICD9.name(), TreeSubType.CM.name(), "002", "blah chol", 0, false, true, null);
    Criteria icd9Criteria2 =
        createCriteria(
                TreeType.ICD9.name(),
                TreeSubType.CM.name(),
                "001",
    ...
    Criteria icd10Criteria2 =
        createCriteria(
            ...
            true,
            null);
    Criteria cptCriteria1 =
        createCriteria(
            TreeType.CPT.name(),
            TreeSubType.CPT4.name(),
            "0039T",
            "zzzcptzzz",
            0,
            false,
    ...
    Criteria pmCriteria =
        createCriteria(
            ...
            TreeSubType.BP.name(),
            "1",
            "Hypotensive (Systolic <= 90 / Diastolic <= 60)",
            0,
            false,
            true,
            "1.2.3.4");
  ...
  public void findCriteriaByTypeAndSubtypeAndParentIdOrderByIdAsc() throws Exception {
    Criteria drugCriteriaIngredient =
        createCriteria(
                TreeType.DRUG.name(),
                TreeSubType.ATC.name(),
                "1",
                "ACETAMIN",
                0,
                false,
                ...
                "1.2.3.4")
            .conceptId("1");
    Criteria drugCriteriaIngredient1 =
        createCriteria(
                TreeType.DRUG.name(),
                TreeSubType.ATC.name(),
                "2",
    ...
    final List<Criteria> drugList =
        criteriaDao.findCriteriaByTypeAndSubtypeAndParentIdOrderByIdAsc(
            TreeType.DRUG.name(), TreeSubType.ATC.name(), 0L);
  ...
  public void findCriteriaByType() throws Exception {
    ...
    final Set<String> typeList =
        icd9List.stream().map(Criteria::getType).collect(Collectors.toSet());
  ...
  public void findCriteriaByTypeForCodeOrName() throws Exception {
    ...
    List<Criteria> labs =
        criteriaDao.findCriteriaByTypeForCodeOrName(
            TreeType.MEAS.name(), "LP123", "LP1234", new PageRequest(0, 10));
  ...
  public void findCriteriaByTypeAndSubtypeForCodeOrName() throws Exception {
    ...
    List<Criteria> conditions =
        criteriaDao.findCriteriaByTypeAndSubtypeForCodeOrName(
            TreeType.ICD9.name(), TreeSubType.CM.name(), "001", "001", new PageRequest(0, 10));
    assertEquals(1, conditions.size());
    assertEquals(icd9Criteria2, conditions.get(0));

    conditions =
        criteriaDao.findCriteriaByTypeAndSubtypeForCodeOrName(
            TreeType.ICD9.name(), TreeSubType.CM.name(), "002", "002", new PageRequest(0, 10));
    assertEquals(1, conditions.size());
  ...
  public void findCriteriaByTypeAndSubtypeForName() throws Exception {
    ...
    List<Criteria> conditions =
        criteriaDao.findCriteriaByTypeAndSubtypeForName(
            TreeType.ICD9.name(), TreeSubType.CM.name(), "001", new PageRequest(0, 10));
    assertEquals(1, conditions.size());
    assertEquals(icd9Criteria2, conditions.get(0));
  }
  ...
  public void findCriteriaByTypeAndSubtypeOrderByIdAsc() throws Exception {
    ...
    final List<Criteria> demoList =
        criteriaDao.findCriteriaByTypeAndSubtypeOrderByIdAsc(
            TreeType.DEMO.name(), TreeSubType.RACE.name());
  ...
  public void findDrugBrandOrIngredientByName() throws Exception {
    ...
    Criteria drugCriteriaIngredient1 =
        createCriteria(
                ...
                "1.2.3.4")
            .conceptId("2");
    Criteria drugCriteriaBrand =
        createCriteria(
            TreeType.DRUG.name(), TreeSubType.BRAND.name(), "3", "BLAH", 0, false, true, "");
    criteriaDao.save(drugCriteriaIngredient);
    criteriaDao.save(drugCriteriaIngredient1);
  ...
  public void findDrugIngredientsByConceptId() throws Exception {
    ...
    jdbcTemplate.execute(
        "insert into criteria_relationship(concept_id_1, concept_id_2) values (12345, 1)");
    Criteria drugCriteriaIngredient =
        createCriteria(
                TreeType.DRUG.name(),
                TreeSubType.ATC.name(),
