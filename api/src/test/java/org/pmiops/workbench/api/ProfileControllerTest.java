...
public class ProfileControllerTest {
    ...
    private InvitationVerRequest invitationVerRequest;
    ...
    public void setUp() {
        ...
        invitationVerRequest = new InvitationVerRequest();
        ...
        invitationVerRequest.setInvitationKey(INVITATION_KEY);
    ...
    public void testInvitationKeyVerification_invitationKeyMismatch() throws Exception {
        //when(cloudStorageService.readInvitationKey()).thenReturn("BLAH");
        profileController.invitationKeyVerification(invitationVerRequest);
    }
