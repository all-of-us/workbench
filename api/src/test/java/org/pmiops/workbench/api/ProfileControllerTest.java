...
public class ProfileControllerTest extends BaseControllerTest {
  ...
  public void testCreateAccount_withTosVersion() {
    ...
    assertThat(tosRows.get(0).getTosVersion()).isEqualTo(CURRENT_TERMS_OF_SERVICE_VERSION);
  ...
  public void testCreateAccount_withBadTosVersion() {
    assertThrows(
        BadRequestException.class,
        () -> {
          createAccountRequest.setTermsOfServiceVersion(CURRENT_TERMS_OF_SERVICE_VERSION - 1);
          createAccountAndDbUserWithAffiliation();
        });
  }
