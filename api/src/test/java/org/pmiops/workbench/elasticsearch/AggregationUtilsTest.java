...
public class AggregationUtilsTest {
  ...
  public void buildDemoChartAggregation() throws Exception {
    AggregationBuilder actualBuilder = AggregationUtils.buildDemoChartAggregation(RANGE_19_44);
    assertThat(actualBuilder.getName()).isEqualTo(DATE + RANGE_19_44);
    ...
    assertThat(genderBuilder.getName()).isEqualTo(GENDER + RANGE_19_44);
    ...
    assertThat(raceBuilder.getName()).isEqualTo(RACE + RANGE_19_44);
