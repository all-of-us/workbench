...
public class ReportingTestUtils {
  ...
  public static BqDtoUser createDtoUser() {
    return new BqDtoUser()
        ...
        .complianceTrainingCompletionTime(offsetDateTimeUtc(USER__COMPLIANCE_TRAINING_COMPLETION_TIME))
        .complianceTrainingExpirationTime(offsetDateTimeUtc(USER__COMPLIANCE_TRAINING_EXPIRATION_TIME))
        ...
        .demographicSurveyCompletionTime(offsetDateTimeUtc(USER__DEMOGRAPHIC_SURVEY_COMPLETION_TIME))
        .disabled(USER__DISABLED)
        .emailVerificationBypassTime(offsetDateTimeUtc(USER__EMAIL_VERIFICATION_BYPASS_TIME))
        .emailVerificationCompletionTime(offsetDateTimeUtc(USER__EMAIL_VERIFICATION_COMPLETION_TIME))
        ...
        .firstRegistrationCompletionTime(offsetDateTimeUtc(USER__FIRST_REGISTRATION_COMPLETION_TIME))
