...
public class NotebooksServiceTest {
  ...
  public void testSaveNotebook_firesMetric() {
    ...
    verify(mockMonitoringService).recordDelta(Metric.NOTEBOOK_SAVE);
  }
  ...
  public void testDeleteNotebook_firesMetric() {
    ...
    verify(mockMonitoringService).recordDelta(Metric.NOTEBOOK_DELETE);
  }
  ...
  public void testCloneNotebook_firesMetric() {
    ...
    assertThat(bundle.getAttachments().get(AttachmentKey.NOTEBOOK_NAME.getKeyName()).getValue()).isEqualTo(clonedFileDetail.getName());
