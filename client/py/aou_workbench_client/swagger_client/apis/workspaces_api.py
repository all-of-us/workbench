...
class WorkspacesApi(object):
    ...
    def clone_workspace_with_http_info(self, workspace_namespace, workspace_id, **kwargs):
        ...
        return self.api_client.call_api('/api/v1/workspaces/{workspaceNamespace}/{workspaceId}/clone', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_workspaces_for_review_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/api/v1/workspaces/review', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def review_workspace_with_http_info(self, workspace_namespace, workspace_id, **kwargs):
        ...
        return self.api_client.call_api('/api/v1/workspaces/{workspaceNamespace}/{workspaceId}/review', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def share_workspace_with_http_info(self, workspace_namespace, workspace_id, **kwargs):
        ...
        return self.api_client.call_api('/api/v1/workspaces/{workspaceNamespace}/{workspaceId}/share', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
