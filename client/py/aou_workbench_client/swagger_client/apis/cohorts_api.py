...
class CohortsApi(object):
    ...
    def delete_cohort(self, workspace_namespace, workspace_id, cohort_id, **kwargs):
        ...
        :param int cohort_id: ID of the workspace containing the cohort definition (required)
    ...
    def materialize_cohort(self, workspace_namespace, workspace_id, **kwargs):
        ...
        :param async bool
        :param str workspace_namespace: namespace of the workspace that the cohort will be materialized in the context of (required)
        :param str workspace_id: ID of the workspace that the cohort will be materialized in the context of (required)
    ...
    def materialize_cohort_with_http_info(self, workspace_namespace, workspace_id, **kwargs):
        ...
        return self.api_client.call_api('/api/v1/workspaces/{workspaceNamespace}/{workspaceId}/materializeCohort', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
