...
class Profile(object):
    ...
    def __init__(self, email=None, enabled_in_fire_cloud=None, free_tier_billing_project_name=None, data_access_level=None, full_name=None, given_name=None, family_name=None, phone_number=None):
        """
    ...
    def data_access_level(self, data_access_level):
        ...
        allowed_values = ["registered", "protected"]
        if data_access_level not in allowed_values:
            raise ValueError(
                "Invalid value for `data_access_level` ({0}), must be one of {1}"
                .format(data_access_level, allowed_values)
            )
    ...
    def full_name(self):
        """
        Gets the full_name of this Profile.
        the user's full name

        :return: The full_name of this Profile.
        :rtype: str
        """
    ...
    def full_name(self, full_name):
        """
        Sets the full_name of this Profile.
        the user's full name

        :param full_name: The full_name of this Profile.
        :type: str
        """
