...
class Workspace(object):
    ...
    def __init__(self, id=None, name=None, namespace=None, description=None, cdr_version_id=None, creator=None, data_access_level=None, research_purpose=None, creation_time=None, last_modified_time=None):
        """
